...
{
    ui->setupUi(this);
    setWindowTitle("Тест по вселенной Звёздные Войны");
    QPixmap* pixmap = new QPixmap(":/ZV1.jpeg");;
    QPixmap* pixmap1 = new QPixmap(":/ZV2.jpeg");;
    ui->label->setPixmap(pixmap->scaled(size(), Qt::KeepAspectRatio));
     ui->label_2->setPixmap(pixmap1->scaled(size(), Qt::KeepAspectRatio));
